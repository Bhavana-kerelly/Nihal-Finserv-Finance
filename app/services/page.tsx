...
const slideVariants = {
  ...
  exit: (dir = 1) => ({
    ...
    x: dir > 0 ? -40 : 40,
    scale: 0.99,
    transition: { duration: 0.45, ease: "easeInOut" }, // use a valid easing string
  }),
};
    ...
    <section className="relative w-full overflow-hidden text-white py-20">
      ...
      <div className="absolute inset-0 -z-20">
        ...
        <motion.div
          ...
          transition={{ duration: 25, repeat: Infinity, ease: [0, 0, 1, 1] }} // linear
        ...
        <motion.div
          ...
          transition={{ duration: 18, repeat: Infinity, ease: [0.42, 0, 0.58, 1] }} // cubic-bezier for easeInOut
        />
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 10, ease: [0, 0, 1, 1], repeat: Infinity }} // linear
              >
                <Image
